...
async function test31Lite() {
  ...
  const modelsToTest = ['gemini-3.5-flash-lite', 'gemini-3.1-flash-lite', 'gemini-3.6-flash'];
    ...
    for (const mName of modelsToTest) {
      ...
      try {
        ...
        const response = await ai.models.generateContent({
          model: mName,
          contents: [
            'คุณคือระบบ AI วิเคราะห์ภาพถ่ายภัยพิบัติฉุกเฉิน ตอบเป็น JSON สั้นๆ: {"risk_level": 3, "ai_score": 50, "situation_summary": "ทดสอบ 3.1 flash lite สำเร็จ"}',
