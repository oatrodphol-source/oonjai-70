        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            <Card className="p-4 sm:p-6 h-full flex flex-col">
              ...
              <div className="flex-1 w-full bg-slate-50 dark:bg-slate-900/50 rounded-xl overflow-hidden relative" style={{ minHeight: '750px' }}>
                <iframe 
                  width="100%" 
                  height="750" 
                  ...
                  frameBorder="0" 
                  className="rounded-xl shadow-md border border-gray-200 dark:border-gray-800 absolute inset-0"
