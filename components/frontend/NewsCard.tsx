...
export const NewsCard: React.FC<NewsCardProps> = ({
  ...
  return (
    <div className="bg-white dark:bg-[#151b2c] rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 overflow-hidden mb-6">
      ...
      {imageUrl && (
        <div 
          className="w-full h-64 sm:h-80 bg-gray-200 dark:bg-gray-800 border-y border-gray-100 dark:border-gray-800 overflow-hidden cursor-pointer relative group"
